...
City = 'Milwaukee'; % Choose between 'Milwaukee', 'Atlanta', Dallas'
...
% Adjust the Capacity <- Place for Conducting Trade-off
Factor = 2;
C_E = C_E/Factor;
...
temp_f = temp_c*2+2; % fixed + continued?
temp_f(1) = 0;
